...
final class Mmio {
    ...
    static const mmio_spec = [
        ...
        MmioRegister("dsp",                  "DSP_MAILBOX_TO",     0xCC00_5000, 4, READ_WRITE),
        MmioRegister("dsp",                  "DSP_MAILBOX_FROM",   0xCC00_5004, 4, READ),
        MmioRegister("dsp",                  "DSP_CSR",            0xCC00_500A, 4, READ_WRITE),
    ...
    u32 get_effective_address(u32 address) {
        if (address >= 0xCD000030 && address < 0xCD800030) {
