module emu.hw.memory.strategy.software_mem.mmio_spec;

import emu.hw.broadway.interrupt;
import emu.hw.cp.cp;
import emu.hw.memory.strategy.software_mem.mmio_gen;
...
final class Mmio {
    ...
    static const mmio_spec = [
        ...
        MmioRegister("command_processor",    "CP_FIFO_WP_HI",         0xCC00_0034, 2, READ_WRITE),
        ...
        MmioRegister("dsp",                  "DSP_CSR",               0xCC00_500A, 2, READ_WRITE).dont_decompose_into_bytes(),
        ...
        MmioRegister("dsp",                  "AR_DMA_SIZE",           0xCC00_5028, 4, READ_WRITE).dont_decompose_into_bytes(),
        MmioRegister("dsp",                  "AR_DMA_START_HIGH",     0xCC00_5030, 2, READ_WRITE),
        MmioRegister("dsp",                  "AR_DMA_START_LOW",      0xCC00_5032, 2, READ_WRITE),
        MmioRegister("dsp",                  "AR_DMA_CNT",            0xCC00_5036, 2, READ_WRITE).dont_decompose_into_bytes(),
        MmioRegister("dsp",                  "DSP_DMA_BYTES_LEFT",    0xCC00_503A, 2, READ),
        ...
        MmioRegister("hollywood",            "FIFO_BASE_START",       0xCC00_300C, 4, READ_WRITE),
        MmioRegister("hollywood",            "FIFO_BASE_END",         0xCC00_3010, 4, READ_WRITE),
        MmioRegister("hollywood",            "FIFO_WRITE_PTR",        0xCC00_3014, 4, READ_WRITE),
    ...
    public void connect_memory(SoftwareMem memory) {
        this.memory = memory;
    }
